...
(py-autopep8 py-autopep8 ac-anaconda dash anaconda-mode f dash s s dash pythonic f dash s s dash auto-complete popup ac-clang yasnippet pos-tip auto-complete popup ac-helm popup auto-complete popup helm helm-core async async ac-html dash f dash s s auto-complete popup ample-theme ample-zen-theme anaconda-mode f dash s s dash pythonic f dash s s dash auctex auto-complete-clang auto-complete popup autopair color-theme-sanityinc-tomorrow cuda-mode darkburn-theme ecb ein request websocket es-lib exec-path-from-shell flatland-black-theme flatland-theme git-commit-mode git-rebase-mode helm-descbinds helm helm-core async async jedi-direx direx jedi auto-complete popup jedi-core python-environment deferred epc ctable concurrent deferred json-rpc magit magit-popup dash async git-commit with-editor dash async dash with-editor dash async dash async magit-popup dash async markdown-mode+ markdown-mode markdown-mode matlab-mode org php-mode popup-complete popup pos-tip pretty-lambdada py-autopep8 pydoc pydoc-info python-django python-environment deferred pythonic f dash s s dash rainbow-mode request s scss-mode smex tidy websocket with-editor dash async yasnippet zen-and-art-theme)
