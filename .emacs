...
(custom-set-variables
 ...
 '(ansi-term-color-vector
   [unspecified "#393939" "#f2777a" "#99cc99" "#ffcc66" "#6699cc" "#cc99cc" "#6699cc" "#e8e6df"] t)
 ...
 '(package-selected-packages
   (quote
	(jinja2-mode company-nginx nginx-mode neotree ivy-yasnippet yasnippet-snippets esup deadgrep docker-compose-mode dockerfile-mode company-statistics company-auctex company-bibtex company-ghc company-glsl rustic paradox company-irony company-irony-c-headers company-web csharp-mode company-jedi company-lua omnisharp haskell-mode flycheck-rust go-mode wc-mode use-package undo-tree toc-org tidy smex scss-mode rainbow-mode python-django py-isort py-autopep8 powerline php-mode phi-rectangle org-wunderlist org-wc org-ref org-mobile-sync org-dotemacs multiple-cursors mode-icons markdown-mode+ magit json-rpc jedi-direx flycheck flx exec-path-from-shell es-lib elpy ein ecb cuda-mode counsel-projectile autopair auctex anaconda-mode)))
